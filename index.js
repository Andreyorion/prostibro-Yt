...
bot.command('link', (ctx) => ctx.reply({ source: '1.jpg' }, { caption: "/tg телеграмм\n/tt мой тик ток\n/vk я в контакте\n/donation поддержать меня монеткой\n/insta моя инста\n/yt ютуб канал\n\n/help для того чтобы вернуться в главное меню"}))
bot.command('tg', (ctx) => ctx.replyWithPhoto({ source: '1.jpg' }, { caption: "https://youtube.com/channel/UCixpDFP-NdB8ywP_ieygAMQ" }))
...
bot.command('insta', (ctx) => ctx.replyWithPhoto({ source: '1.jpg' }, { caption: "https://www.instagram.com/prosti_bro/" }))
bot.command('tt', (ctx) => ctx.replyWithPhoto({ source: '1.jpg' }, { caption: "https://vm.tiktok.com/ZSeyrX4TC/" }))
bot.command('vk', (ctx) => ctx.replyWithPhoto({ source: '1.jpg' }, { caption: "https://m.vk.com/zarubin_aleksandr" }))
bot.command('donation', (ctx) => ctx.replyWithPhoto({ source: '1.jpg' }, { caption: "https://www.donationalerts.com/r/prosti_bro" }))
bot.launch()